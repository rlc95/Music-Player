  ...
  <div class="bg-gray-500">
    <div class="relative z-0 w-full h-full">
        <lottie-player
            ...
            speed="1"
            class="fixed top-0 left-0 w-full h-[75%] z-0 pointer-events-none mt-[250px] sm:mt-[200px] md:mt-[200px] lg:mt-[200px]"
            loop
            autoplay
        ></lottie-player>
        ...
        <lottie-player
            ...
            background="transparent"
            speed="1"
            class="fixed top-0 left-0 w-full h-[75%] z-10 pointer-events-none mt-[200px]"
            loop
            autoplay
        ></lottie-player>
        </div>
    ...
    <main class="relative z-20 pt-24 min-h-screen px-4 flex flex-col items-center">
